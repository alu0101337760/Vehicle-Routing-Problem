namespace DAA_VRP
{
    class Program
    {
        ...
        //    PrintGvnsSolutions(sequentialGvnsSolutionsAlternativeOrder);
        //    //////////////////////////////////////////////////
        //}


        /// Alternative main program used to find the best possible solutions for every problem with every 
        /// Algorithm.
        public static void Main(string[] args)
        {
            ...
            ///////////////// MODIFICIACION //////////////////
            List<GvnsSolution> bestSequentialGvnsSolutions = new List<GvnsSolution>();
            List<GvnsSolution> bestSequentialGvnsSolutionsAlternativeOrder = new List<GvnsSolution>();
            //////////////////////////////////////////////////
            ...
            foreach (string filename in Directory.EnumerateFiles(path, "*.txt"))
            {
                ...
                ///////////////// MODIFICIACION //////////////////
                bestSequentialGvnsSolutions.Add(vrp.SolveGvns(RCL_SIZE, GvnsTypes.SEQUENTIAL_VND_1));
                bestSequentialGvnsSolutionsAlternativeOrder.Add(vrp.SolveGvns(RCL_SIZE, GvnsTypes.SEQUENTIAL_VND_2));
                //////////////////////////////////////////////////
            }
            ...
            for (int it = 0; it < 5; it++)
            {
                for (int i = 0; i < problems.Count; i++)
                {
                    ...
                    GvnsSolution curretSequentialGvnsSolution = vrp.SolveGvns(RCL_SIZE, GvnsTypes.SEQUENTIAL_VND_1);
                    if (curretSequentialGvnsSolution.totalDistance < bestSequentialGvnsSolutions[i].totalDistance)
                    {
                        bestSequentialGvnsSolutions[i] = curretSequentialGvnsSolution;
                    }

                    GvnsSolution curretSequentialGvnsSolutionAlternativeOrder = vrp.SolveGvns(RCL_SIZE, GvnsTypes.SEQUENTIAL_VND_2);
                    if (curretSequentialGvnsSolutionAlternativeOrder.totalDistance < bestSequentialGvnsSolutionsAlternativeOrder[i].totalDistance)
                    {
                        bestSequentialGvnsSolutionsAlternativeOrder[i] = curretSequentialGvnsSolutionAlternativeOrder;
                    }
            ...
            Console.WriteLine("Is validated: " + ValidateGvnsSolutions(problems, bestSequentialGvnsSolutions));
            PrintGvnsSolutions(bestSequentialGvnsSolutions);

            Console.WriteLine("Gvns solutions with sequential and an alternative order:");
            Console.WriteLine("Is validated: " + ValidateGvnsSolutions(problems, bestSequentialGvnsSolutionsAlternativeOrder));
            PrintGvnsSolutions(bestSequentialGvnsSolutionsAlternativeOrder);
            //////////////////////////////////////////////////
        }
